...
const packages = [
  {
    ...
    features: ["2 Hours", "Digital Captures", "Custom Overlay", "On-Site Attendant", "Instant Sharing"],
  },
  {
    booth: "360 Booth",
    name: "Premiere",
    ...
    price: "Starting at $XXX",
    features: ["3 Hours", "Slow-Motion Video", "Custom Music Overlay", "LED Lighting", "Social Sharing"],
    featured: true,
  },
  {
    booth: "TXR20 Luxury",
    name: "Luxe",
    description: "Elevated elegance with studio-quality lighting and premium output.",
    price: "Starting at $XXX",
    features: ["3 Hours", "Studio Lighting", "Premium Prints", "Branded Overlays", "Digital Delivery"],
  },
];
          ...
          {packages.map((pkg, i) => (
            <AnimateOnScroll key={i} delay={i * 150}>
              ...
              >
                ...
                <p className="font-heading text-xl text-primary font-semibold mb-6">{pkg.price}</p>
